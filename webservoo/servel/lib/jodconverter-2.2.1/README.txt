...
This is JODConverter version 2.2.1, released on 2007-12-19.
 ...
 * a command line tool (java -jar jodconverter-cli-2.2.1.jar <input-document> <output-document>)
 ...
 * Java 1.4 or higher
 * OpenOffice.org 2.x; the latest stable version (currenty 2.3.1) is generally recommended
