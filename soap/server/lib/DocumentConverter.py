...
# Nicolas Barts, copyleft 2010, CLEO / Revues.org
    "xhtml": {
        FAMILY_TEXT: { "FilterName": "XHTML Writer File" },
        FAMILY_SPREADSHEET: { "FilterName": "XHTML Calc File" },
        FAMILY_PRESENTATION: { "FilterName": "XHTML Draw File" }
    },
    # teioop5
    "teixml": {
        FAMILY_TEXT: { "FilterName": "TEI" },
    }
}
